    ...
    <section className="space-y-8 pb-12">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-emerald-900/40 bg-emerald-950/10 p-5">
          <p className="text-xs font-semibold uppercase tracking-[0.15em] text-emerald-500 mb-2">Codex-Powered</p>
          <p className="text-lg font-bold text-zinc-100 leading-snug">Every line written by Codex 5.3</p>
          <p className="mt-2 text-sm text-zinc-400">
            29 features, 4,000+ lines of TypeScript, React, and Recharts — all generated by Codex via <code className="text-xs bg-zinc-800 px-1 rounded">codex exec --full-auto</code>. The harness calls it once per feature with a spec. It builds, the harness decides if it ships.
          </p>
        </div>
        <div className="rounded-xl border border-purple-900/40 bg-purple-950/10 p-5">
          <p className="text-xs font-semibold uppercase tracking-[0.15em] text-purple-500 mb-2">Humanless</p>
          <p className="text-lg font-bold text-zinc-100 leading-snug">No human code, no human QA</p>
          <p className="mt-2 text-sm text-zinc-400">
